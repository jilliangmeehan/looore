...
draft:
---
Just like [[Natlan cast names|last year]], I'm gonna do a rundown of the Nod-Krai cast that we've seen in the latest teaser. I'll try to go a little more in-depth this time — possible name etymology, what we can guess from their design, etc. To keep this from getting too long, though, most of my thoughts on the teaser are [[Moonlit Ballad of the Night|here]].

<iframe width="560" height="315" src="https://www.youtube.com/embed/QWDyxSo-oq0?si=myigb6uqcjoDnpra" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

## [Nicole Reeyn](https://genshin-impact.fandom.com/wiki/Nicole_Reeyn)
![[Nicole.png]]
The etymology listed on Nicole's wiki page (linked above) is pretty solid: "Nicole Reeyn ultimately derives from the name [Nicole-Reine Lepaute](https://en.wikipedia.org/wiki/Nicole-Reine_Lepaute "wikipedia:Nicole-Reine Lepaute"), who was a French astronomer and human computer."
...
> [!jillian]
> Given Aino's connection to Ineffa, plus [the new event claymore](https://gi20.hakush.in/weapon/12432) coming out that is pretty clearly for a Hydro user, it's not too difficult to guess that Aino might have a Hydro vision even though we didn't see one.

## [Varka](https://genshin-impact.fandom.com/wiki/Varka)
![[Varka.png]]
The wiki claims his name is most likely based on an [Old Persian word](https://en.wiktionary.org/wiki/%F0%90%8E%BA%F0%90%8E%BC%F0%90%8E%A3#Old_Persian) meaning *wolf*. There is a Persian epic called [Varka and Golshah](https://en.wikipedia.org/wiki/Varka_and_Golshah) that I don't think is really relevant to our Varka, but it's at least an example of the name being used. Since he's the Knight of Boreas, and he's chasing after the moon for some unspecified reason, I think *wolf* makes perfect sense for him.

Aside from that, there is also a Serbo-Croatian word that means *[illusion](https://en.wiktionary.org/wiki/varka)*, and a similar Greek word (βάρκα) that means *[boat](https://en.wiktionary.org/wiki/%CE%B2%CE%AC%CF%81%CE%BA%CE%B1),* both of which are interesting to me. I also found an old Discord message of mine where I said I found something saying it could be "a russian name of greek origin that means something akin to outsider" — but I can't find the source of that anymore, so who knows.
...
## [Durin](https://genshin-impact.fandom.com/wiki/Mini_Durin)
![[Durin.png]]
The name Durin comes from [Tolkien's Dwarves](https://en.wikipedia.org/w/index.php?title=Dwarves_in_Middle-earth&useskin=vector#Durin) — I am not super familiar with this stuff, but as far as I can tell Durin was the first to awaken of seven "Fathers of the Dwarves." There are other Durins in the line after Durin I, and there are also a few Thrains and Dains as well, since Tolkien was drawing heavily from Norse myth.
...
## [Sandrone](https://genshin-impact.fandom.com/wiki/Sandrone)
![[Sandrone.png]]
We're all probably already familiar with the fact that [Sandrone](https://en.wikipedia.org/wiki/Sandrone) is one of the Commedia dell'arte character archetypes. Her codename, [Marionette](https://en.wikipedia.org/wiki/Marionette), also has pretty obvious origins — especially now that we can see the mechanical key in her back.
...
## [Columbina](https://genshin-impact.fandom.com/wiki/Columbina)
![[Columbina.png]]
Columbina's name comes from the [Columbine](https://en.wikipedia.org/wiki/Columbine_(stock_character)) Commedia dell'arte character, but also from [a genus of doves](https://en.wikipedia.org/wiki/Columbina_(bird))  — which is fitting, since her constellation is probably the one that looks like a crying bird.
...
## [Alice](https://genshin-impact.fandom.com/wiki/Alice)
![[Alice.png]]
...
[^1]: Alice's dialogue about Nicole from the [third act](https://genshin-impact.fandom.com/wiki/Joy_Above_the_Clouds) of the Windblume's Breath event.

[^2]: I don't know if this is making any other HSR players perk up, but something about the fact that "Kalevala" sounds a bit similar to "[Kakavasha](https://honkai-star-rail.fandom.com/wiki/Aventurine)" + Varka having a very Aventurine-looking coat on is interesting to me. The Kalevala also tells the story of [Sampo](https://en.wikipedia.org/wiki/Sampo).
