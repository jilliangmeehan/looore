...
> 
> We can also at least guess that it will be somewhere north of Natlan, based on [[What to know before Nod-Krai|Helka's notes]].
...
[*Paha*](https://en.wikipedia.org/wiki/Paha_(landform)) is a type of landform, and also means *hill* in Dakota Sioux. The other important word here is *Kuuvahki*, which we've heard before in [a letter](https://genshin-impact.fandom.com/wiki/Atocpan) written by someone named Madam Tanya Kovalevskaya that can be found in a Fatui camp in Atocpan:
...
> Kuuvahki appears to be a portmanteau of the Finnish words _[kuu](https://en.wiktionary.org/wiki/kuu#Finnish "wiktionary:kuu")_ "moon" + _[väki](https://en.wikipedia.org/wiki/v%C3%A4ki "wikipedia:väki")_ "power; people". In Finnish mythology, väki is a type of supernatural power which resides in all things.
...
[*Hiisi*](https://en.wikipedia.org/wiki/Hiisi) is a term seen in different Finnic mythologies that can mean many different things, but generally refers to sacred or magical sites. Since Hiisi Island is where the Frostmoon Scions now live, after leaving their golden city of Hyperborea, the name fits.

![[columbinastatuehiisi.png]]
...
The most interesting thing here: the Frostmoon Scions were only founded 500 years ago, either during or after the cataclysm. But Hyperborea is probably much more ancient than that. Judging by the ruins on Hiisi Island, and the story about Ajax stumbling into what sounds like the Hyperborea ruins in [Ballad of the Fjords](https://genshin-impact.fandom.com/wiki/Ballad_of_the_Fjords), I think they relocated sometime during [the Funerary Year](https://genshin-impact.fandom.com/wiki/Before_Sun_and_Moon) (which Nicole also mentioned in [[Moonlit Ballad of the Night]]). 
...
Nasha Town is the place [[What to know before Nod-Krai|Liben]] told us about, where he absolutely got scammed by the Voynich Guild. This is clearly the main city, where the Adventurer's Guild and forge will be.

The name *Nasha* probably comes from [наш](https://en.wiktionary.org/wiki/%D0%BD%D0%B0%D1%88#Russian), which means *our* — so it's "our town." Cute.
...
*[Lempo](https://en.wikipedia.org/wiki/Lempo)* is the name of "a fiend in Finnish folklore." Great phrase. Lempo seems to be connected to themes of love (or lust) and fire, which is very interesting but admittedly doesn't give me many clues about this location.

However! I did find this, to tie the three islands in Nod-Krai together:

> Lempo brought down the hero [Väinämöinen](https://en.wikipedia.org/wiki/V%C3%A4in%C3%A4m%C3%B6inen "Väinämöinen") with the help of his two demon cohorts, Hiisi and Paha.

Väinämöinen is the hero of the [*Kalevala*](https://en.wikipedia.org/wiki/Kalevala), which seems to be a big running source of inspiration for Hoyo. 

> [!jillian] 
> This is really not the time or place to get into it, but this also led me down a bit of a rabbit hole because there's a story that says Väinämöinen's father is [Kave-Ukko](https://en.wikipedia.org/wiki/Kave_(Finnish_mythology)), Lord of the North. Yes, like Kaveh. I don't know what to do with this information.
> 
> This is also a fantastic time to bring [Ukko](https://genshin-impact.fandom.com/wiki/Ukko) up again, since he's named after a [Finnish god](https://en.wikipedia.org/wiki/Ukko). Sal Vindagnyr is always relevant!
...
The mention of the "rules" and "death" seems like it's about the [[Four Shades|Shades]].  
...
As far as we know, the three moons definitely predate the Primordial One. Based on that, and this mural in Natlan, I assume the "now-nameless ruler" mentioned here is [Nibelung](https://genshin-impact.fandom.com/wiki/Nibelung).
...
[^1]: According to Skirk's voice lines, Alice is the "Sustainer of the World's Borders." She clearly has plenty of experience with creating and sustaining worlds, as we've seen in all our little summer adventures.
